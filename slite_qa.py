...
def main():
    ...
    if not all([gemini_api_key, slite_api_key]):
        print("Error: Please ensure both GEMINI_API_KEY and SLITE_API_KEY are set in your .env file.")
        return
        
    try:
        agent = SliteQAAgent(gemini_api_key, slite_api_key, channel_id)
